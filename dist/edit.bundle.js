...
var CloseError = function () {
  function CloseError() {
    _classCallCheck(this, CloseError);
  }

  _createClass(CloseError, [{
    key: 'update',
    value: function update() {
      ...
      $('[name=closeErrorBtn]').on('mouseenter', function () {
        $(this).css({
          'cursor': 'pointer'
        });
...
var _closeError = __webpack_require__(5);

var _closeError2 = _interopRequireDefault(_closeError);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function showErrors($errorsDiv, errors) {
  errors.forEach(function (error) {
    var errorHTML = '\n      <div class="card-panel red lighten-2 white-text row">\n        <div class="col s11">\n          ' + error + '\n        </div>\n        <span class="right-align col s1" name="closeErrorBtn">\xD7</span>\n      </div>\n      ';
    $errorsDiv.append(errorHTML);
  });
  new _closeError2.default().update();
}
...
function createWebsocket($errorsDiv) {
...
exports.default = fillUserProfile;
...
exports.default = getUserInformationAjax;

var _showErrors = __webpack_require__(6);

var _showErrors2 = _interopRequireDefault(_showErrors);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function getUserInformationAjax(userId, callbacks) {
  $.ajax({
    ...
    success: function success(data) {
      if (data.errors !== undefined && data.errors.length != 0) {
        (0, _showErrors2.default)($('#errors'), data.errors);
        return;
      }
    ...
    error: function error(jqXHR, status) {
      (0, _showErrors2.default)($('#errors'), ['Не удалось получить данные']);
    }
  });
}
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var _fillUserProfile = __webpack_require__(28);

var _fillUserProfile2 = _interopRequireDefault(_fillUserProfile);

var _showErrors = __webpack_require__(6);

var _showErrors2 = _interopRequireDefault(_showErrors);

var _getUserInformationAjax = __webpack_require__(29);

var _getUserInformationAjax2 = _interopRequireDefault(_getUserInformationAjax);
...
var closeError = new _closeError2.default();
closeError.update();
...
$('#saveButton').click(function (e) {
  ...
  $('#errors').empty();
  if (errors.length != 0) {
    (0, _showErrors2.default)($('#errors'), errors);
    return;
  }
...
function turnOnUserUpdateWithWebSocket(userdata, $errorsDiv) {
  socket = (0, _ws2.default)($errorsDiv);
...
function updateUserWithAjax(userdata, $errorsDiv) {
  $.ajax({
    ...
    success: function success(data) {
      if (data.errors !== undefined && data.errors.length != 0) {
        (0, _showErrors2.default)($errorsDiv, data.errors);
        return;
      }

      (0, _fillUserProfile2.default)(data);
      //TODO empty all form fields
    },
    error: function error(jqXHR, status) {
      console.log("error status: " + status);
      (0, _showErrors2.default)($errorsDiv, ['Не удалось обновить данные']);
    }
  });
}

(0, _getUserInformationAjax2.default)(userId, [_fillUserProfile2.default, fillUserForm]);
// $.ajax({
//   url: 'http://localhost:8008/user/' + userId,
//   method: 'GET',
//   dataType: 'json',
...
function validateLastName(maxSymbolsAmount) {
  var lastName = new _validator2.default($('input[name="lastName"]').val());
  var errors = [];
...
function validateFirstName(maxSymbolsAmount) {
  var firstName = new _validator2.default($('input[name="firstName"]').val());
  var errors = [];
...
function validateMiddleName(maxSymbolsAmount) {
  var middleName = new _validator2.default($('input[name="middleName"]').val());
  var errors = [];
...
function validateAge(minAge, maxAge) {
  var age = new _validator2.default($('input[name="age"]').val());
  var errors = [];
...
var Validator = function () {
  ...
  _createClass(Validator, [{
    key: "hasMoreSymbolsThan",
    value: function hasMoreSymbolsThan(amount) {
    ...
    key: "isNotNumber",
    value: function isNotNumber() {
      if (!this.isNumber()) return true;
      return false;
    }
  }, {
    key: "isLessThan",
    value: function isLessThan(amount) {
    ...
    key: "isMoreThan",
    value: function isMoreThan(amount) {
      var val = Number(this.text);
